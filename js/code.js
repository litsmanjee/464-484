...
// 465 1
// let arr = [1, 2, 3, 4, 5];
// let ul = document.querySelector("#elem465");

// arr.forEach(elem465 => {
//   let li = document.createElement('li');
//   li.textContent = elem465;
//   ul.appendChild(li);
// });
...
// let table = document.querySelector("#arrayta");
...
//     newLi.textContent = document.querySelectorAll("#elem472 li").length + 1;
//     document.querySelector('elem472').appendChild(newLi);
//     newLi.addEventListener('click', function() {
//         this.remove();
//     });
// });
// document.querySelectorAll("#elem472 li").forEach(li => {
//     li.addEventListener('click', function() {
//         this.remove();
//     });
// });
...
//     document.querySelector("#elem473").remove();
// });

// 474 1
// let listItems = document.querySelector("#list").getElementsByTagName('li');
...
// 475 1
// let elem475 = document.querySelector("#elem475");
// let input = document.querySelector("#input");
// input.addEventListener('input', function() {
//     elem475.textContent = this.value;
// });

// 475 2
// document.querySelector("#elem4755").addEventListener('click', function() {
//     let input = document.createElement('input');
//     input.setAttribute('id', 'input');
//     document.querySelector("#parent").appendChild(input);
//     input.addEventListener('input', function() {
//         document.querySelector('elem4755').textContent = this.value;
//     });
// });

// 476 1
// document.querySelector("#elem476").addEventListener('click', function() {
//     let input = document.createElement('input');
//     input.setAttribute('id', 'input');
//     input.setAttribute('type', 'text');
//     input.value = document.querySelector("#elem476").textContent;
//     document.querySelector("#parent").replaceChild(input, document.querySelector("#elem476"));
//     input.addEventListener('blur', function() {
//         document.querySelector("#parent").replaceChild(document.querySelector('elem476'), input);
//         document.querySelector("#elemelem476").textContent = this.value;
//     });
// });
...
// 480 1
// let elem480 = document.querySelector("#elem480"); 
// let toggle = document.querySelector("#toggle"); 
// let isHidden = false;
// toggle.addEventListener('click', function() { 
//     if (isHidden) {
//         elem480.classList.remove('hidden');
//         isHidden = false;
//     } else {
//         elem480.classList.add('hidden');
//         isHidden = true;
//     }
// });
...
// 484 1
// const array = ['элемент1', 'элемент2 'элемент3', 'элемент4'];
...
//     const row = employee.insertRow(-1);
...
//      employee.deleteRow(index + 1); // +1 to account for table header row
//    }
...
//        // Update the employee object when input is changed
